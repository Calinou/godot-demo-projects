...
## Speed of rotation in radians per second. This is purely a visual effect
## and has no impact on gameplay.
@export var rotationSpeed = 16.0
...
func _ready():
	...
	# This will change according to the screen size.
